...
## 🚀 Deployment (LEGION NETWORK)
1. **Prepare**: Ensure your `dl_sms_client` folder contains `index.html`, `client.html`, and `bridge.js`.
2. **Upload**: Drag and drop the entire project folder into the LEGION Deployment Node.
3. **Configure**: The system already handles the routing via internal protocols.
